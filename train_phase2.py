...
from machine_listener.src.features import compute_mel_sectrogram, compute_MFCC
from machine_listener.src.models import MelMFCCCNN
...
{"params": torch.optim.stream1.parameters(), "lr": 1e-4},   
{"params": torch.optim.stream2.parameters(), "lr": 5e-4},  
{"params": torch.optim.fusion_head.parameters(), "lr": 5e-4},
], weight_decay=1e-4)
...
for epoch in range(30):
    ...
    if val_acc > best_acc:
        best_acc = val_acc
        utils.save_checkpoint(model, optimizer, epoch, val_acc, "phase2_best.pth")
